...
int test() {
    ...
    @autoreleasepool {
        ...
        // Test initWithRect
        CGRect cgRect = CGRectMake(30, 20, 35, 25);
        rect2 = [[PERectangle alloc] initWithRect: cgRect];
        if (!float_equals(rect2.origin.x, 30) || !float_equals(rect2.origin.y, 20) ||
            !float_equals(rect2.width, 35) || !float_equals(rect2.height, 25) ||
            !float_equals(rect2.rotation, 0) ||
            !float_equals(rect2.center.x, 47.5) || !float_equals(rect2.center.y, 7.5))
            return 0;
        ...
        // Test translate
        [rect1 translateX:20 Y: 10];
        if (!float_equals(rect1.origin.x, 0) || !float_equals(rect1.origin.y, 20) ||
            !float_equals(rect1.width, 40) || !float_equals(rect1.height, 20) ||
            !float_equals(rect1.rotation, 0) ||
            !float_equals(rect1.center.x, 20) || !float_equals(rect1.center.y, 10))
            return 0;
        
        corners = [rect1 corners];
        if (!float_equals(corners[0].x, 0) || !float_equals(corners[0].y, 20) ||
            !float_equals(corners[1].x, 40) || !float_equals(corners[1].y, 20) ||
            !float_equals(corners[2].x, 40) || !float_equals(corners[2].y, 0) ||
            !float_equals(corners[3].x, 0) || !float_equals(corners[3].y, 0))
            return 0;
...
/* 
 ...
 I spent a 3-4 hours on the first problem (most of the time is used to warm up and getting used to the environment
